...
function StatCardItem({ card, index }: { card: StatCard; index: number }) {
  ...
  return (
    <div
      ...
      className="flex-1 rounded-2xl border border-gray-200 bg-surface shadow-sm p-5 flex flex-col gap-2 animate-in fade-in slide-in-from-bottom-2 fill-mode-both duration-400 ease-out-quart"
    >
    ...
    <AdminShell slug={slug} title="Дашборд" subtitle={community?.displayName}>
      {isLoading || !stats ? (
        ...
        <div className="p-4 md:p-6 space-y-5 max-w-5xl">
          ...
          {/* Графики */}
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-[2] min-w-0 rounded-2xl border border-gray-200 bg-surface shadow-sm p-5">
              <div className="flex items-center justify-between mb-3">
                <span className="text-[15px] font-bold text-ink">Доход</span>
            ...
            <div className="flex-1 min-w-0 rounded-2xl border border-gray-200 bg-surface shadow-sm p-5">
              <div className="flex items-center justify-between mb-3">
                <span className="text-[15px] font-bold text-ink">Рост участников</span>
              </div>
          ...
          {/* Тарифы */}
          <div className="rounded-2xl border border-gray-200 bg-surface shadow-sm p-5">
            <span className="text-[15px] font-bold text-ink">Тарифы</span>
              ...
              <div className="mt-3 overflow-x-auto">
                ...
                {stats.tierStats.map((tier) => (
                  ...
                  >
                    ...
                    <span className="w-24 text-right text-sm font-semibold font-mono text-ink">
