...
export function Login() {
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-cover bg-center bg-black bg-opacity-30 bg-blend-darken">
      ...
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-md p-8 z-10 relative animate-in fade-in zoom-in-95 slide-in-from-bottom-2 duration-400 ease-out-quart">
