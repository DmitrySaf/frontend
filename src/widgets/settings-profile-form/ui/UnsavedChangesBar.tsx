  ...
  return (
    <div className="sticky bottom-4 left-0 right-0 bg-surface border border-gray-200 rounded-xl shadow-lg p-3 pl-5 flex items-center justify-between">
      ...
      <div className="flex gap-3">
        <Button type="button" theme="ghost" size="lg" onClick={onReset} isDisabled={isSubmitting}>
          Сбросить
        </Button>
        <Button type="button" theme="primary" size="lg" onClick={onSave} isLoading={isSubmitting}>
          Сохранить
        </Button>
      </div>
    </div>
