...
export default defineConfig({
  ...
  timeout: 120_000,
  // Весь прогон не молотит дольше 25 мин — страховка от сломанной сборки/зависшего
  // вебсервера (иначе 27 тестов × ретраи грызут по 40с вслепую, как случилось со stale .next).
