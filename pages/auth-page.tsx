...
export default function Component() {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center bg-cover bg-center bg-black bg-opacity-30 bg-blend-darken"
      style={{ backgroundImage: "url('/auth-bg.jpg')" }}
    >
      {/* Auth Card */}
      <div className="bg-white rounded-[40px] shadow-xl w-full max-w-md p-8 space-y-8">
        {/* Logo and header */}
            ...
            <form onSubmit={handleSendOtp} className="space-y-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full py-3 px-4 text-base border border-gray-300 rounded-[12px] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                />
                {error && (
